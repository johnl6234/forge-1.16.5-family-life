...
import com.deadwormy.familyLife.config.ConfigHelper;
...
@EventBusSubscriber(modid = ModFamilyLife.MODID, bus = EventBusSubscriber.Bus.MOD)
public final class ModEventSubscriber {

    private static final Logger LOGGER = LogManager.getLogger(ModFamilyLife.MODID + " Mod Event Subscriber");
